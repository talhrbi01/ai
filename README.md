...
النسخة الحالية هي شريحة تأسيسية قابلة للتوسعة: App shell، التوطين، SwiftData لقائمة المشاهدة، TMDB service، Onboarding، البحث، التفاصيل، وتبويب الملف. ميزات المصادقة عن بعد والمجتمع والمزامنة والإدارة تحتاج تنفيذ مراحل لاحقة وفق `IMPLEMENTATION_PLAN.md`.
