...
النسخة الحالية هي شريحة تأسيسية قابلة للتوسعة: App shell، التوطين، SwiftData لقائمة المشاهدة، TMDB service، Supabase Auth/Apple، Onboarding، البحث، التفاصيل، Queue دون اتصال، جدولة التنبيهات المحلية، وحماية الحرق. المجتمع والمزامنة الخلفية وAPNs والإدارة تحتاج مراحل لاحقة وفق `IMPLEMENTATION_PLAN.md`.
